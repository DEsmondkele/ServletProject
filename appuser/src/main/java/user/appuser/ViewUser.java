...
public class ViewUser extends HttpServlet {
    ...
    processRequest(request,response);
        ...
        List<User> list = null;
        out.println("<a href='/appuser_war_exploded/'>Add user</a>");

        out.print("<h1> User Table: </h1>");
        out.print("<table border='2' cellpadding='4' width='80%'>");
        out.print("<td><tr><th>Id</th><th>username</th><button method='deleteUser'>Delete User</button></tr></td>");
        try {
            //getting all users and assigning to the page numbers
            list = UserDaoHandler.getAllUsers(pagesId,total);
